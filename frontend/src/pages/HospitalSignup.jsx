...
const HospitalSignup = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.id) {
      ...
      newErrors.id =
        "Hospital ID can only contain uppercase letters, numbers, hyphens, and underscores";
    }
      ...
      try {
        ...
        const response = await fetch(
          "http://localhost:5000/api/auth/register",
          {
            ...
            body: JSON.stringify({ role: "hospital", ...submitData }),
          },
        );
    ...
    <div className="hospital-signup-container">
      <form className="hospital-signup-form" onSubmit={handleSubmit}>
        ...
        <p style={{ fontSize: "0.9rem", color: "#555" }}>
          (Demo hospital: <strong>HOSP001</strong> / <strong>password</strong> —
        ...
        <div className="form-section">
          ...
          <p className="help-text">
            Enter the exact coordinates of your hospital location
          </p>
